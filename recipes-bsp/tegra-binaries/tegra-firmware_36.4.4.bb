...
XUSBSUM = "e44ca413e0dc65bbb1455cf585bae5384dd651542cf20855b16fb841f1960e31"
...
PACKAGES = "${PN}-rtl8822 ${PN}-brcm ${PN}-common ${PN}-tegra194 ${PN}-tegra234 ${PN}-xusb ${PN}-vic ${PN}"
...
"
FILES:${PN}-tegra194 = " \
    ${nonarch_base_libdir}/firmware/gv11b \
...
FWDEPS = ""
FWDEPS:tegra234 = "${PN}-tegra234 ${PN}-vic ${PN}-common"
FWDEPS:tegra194 = "${PN}-tegra194 ${PN}-vic ${PN}-common"
